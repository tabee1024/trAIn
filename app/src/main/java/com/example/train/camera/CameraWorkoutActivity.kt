package com.example.train.camera
...
import com.example.train.data.WorkoutSummary
import com.example.train.data.TrainDatabaseHelper
...
class CameraWorkoutActivity : ComponentActivity() {
    ...
    private fun saveAndExit() {
        ...
        val workout: com.example.train.model.WorkoutDefinition = WorkoutCatalog.byId(workoutId)
