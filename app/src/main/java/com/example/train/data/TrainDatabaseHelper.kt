...
import com.example.train.model.WorkoutDefinition
...
class TrainDatabaseHelper(context: Context) :
    ...
    fun saveWorkoutSession(
        ...
        workout: com.example.train.model.WorkoutDefinition,
    ...
    fun getProgressSnapshot(authUid: String?, email: String?, period: String = "Week"): ProgressSnapshot {
        val user = getUserProfile(authUid, email)
            ?: return ProgressSnapshot(
                ...
                recommendation = "Finish your first workout to get AI coaching.",
                recentSessions = emptyList(),
                workoutTrends = emptyMap(), // Added missing parameter
                bodyweightTrend = emptyList() // Added missing parameter
            )
