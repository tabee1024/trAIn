...
fun AboutContents() {
    Column(modifier = Modifier
        ...
        // Mission Statement
        Text(text = "Our Mission", fontWeight = FontWeight.Bold, style = MaterialTheme.typography.headlineSmall, color = Color.Black)
        HorizontalDivider(modifier = Modifier.fillMaxWidth(), color = Emperor, thickness = 0.5.dp)
        ...
        //Major Features
        Text(text = "Major Features", fontWeight = FontWeight.Bold, style = MaterialTheme.typography.headlineSmall, color = Color.Black)
        HorizontalDivider(modifier = Modifier.fillMaxWidth(), color = Emperor, thickness = 0.5.dp)
        Spacer(modifier = Modifier.height(8.dp))
        Text(
        ...
        // Our Audience
        Text(text = "Our Audience",fontWeight = FontWeight.Bold, style = MaterialTheme.typography.headlineSmall, color = Color.Black)
        HorizontalDivider(modifier = Modifier.fillMaxWidth(), color = Emperor, thickness = 0.5.dp)
        Spacer(modifier = Modifier.height(8.dp))
        Text(
        ...
        //Disclaimer
        Text(text = "Disclaimer", fontWeight = FontWeight.Bold, style = MaterialTheme.typography.headlineSmall, color = Color.Black)
        HorizontalDivider(modifier = Modifier.fillMaxWidth(), color = Emperor, thickness = 0.5.dp)
        Spacer(modifier = Modifier.height(8.dp))
        Text(
